...
/*	public void delete(String activityId) {
		WebTarget target = client.target("http://localhost:8080/restful-list-service/webapi/");
	...
	public Activity get(String id) {
		...
		//http://localhost:8080/restful-list-service/webapi/activities/1234
		WebTarget target = client.target("http://localhost:8080/restful-list-service/webapi/");
	...
	public Activity create(Activity activity) {
		//http://localhost:8080/restful-list-service/webapi/activities/activity
		WebTarget target = client.target("http://localhost:8080/restful-list-service/webapi/");
